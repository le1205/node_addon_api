...
public:
   ...
   */
    ...
    */
	...
	void ReadAllNodes(xmlDocPtr doc, GXDLMSXmlSettings& s);

	int XmlToPdu(std::string xml, DLMS_SECURITY_SUITE suite, DLMS_AUTHENTICATION authentication, CGXByteBuffer& output);
};
